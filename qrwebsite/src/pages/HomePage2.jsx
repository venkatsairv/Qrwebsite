          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2">
              <div className="relative bg-surface-container-low p-8 rounded-2xl">
                <img className="rounded-xl soft-lift w-full h-[400px] object-cover" alt="Modern smartphone displaying a clean user interface" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmwhDY7nQrJ13Kfdut9sJK-AjXQFhrLR6h7OFJbNriHVyTfP3KywkWMFcNgzx4P8tJiF37jcCF5y9VLqmD8lpWXKhEkYimc0H8lCmGy2m2bCqENDHRqk7v3N7FvnvDCtV1fOdfYSZKMARImoWrIzzpO4jdPIagFiCpJpFQ_biyA-dTptplagrpAP45sXhpJ_LVE1SpbEzytgtQiw3rBgNfsGVEvNxeI3upfOD9ItfcVK0zUMtaVkmn4U5edF6r19jpszt3_-XAc2g"/>
